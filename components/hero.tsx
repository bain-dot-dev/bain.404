...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-12">
      <motion.main
        className="flex-1 flex flex-col items-start justify-center text-left w-full lg:px-16 lg:w-3/4 xl:w-2/3"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
